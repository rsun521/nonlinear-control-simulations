function Project5(controller,varargin)
% Project5 runs the simulation of a two-wheeled robot
%
%   Project5('FunctionName') uses the controller defined by
%       the function 'FunctionName' - for example, in a file with
%       the name FunctionName.m - in the simulation.
%
%   Project5('FunctionName','P1',V1,'P2','V2',...) optionally
...
process.processdatatolog = {'t','x','y','theta','phi','phidot','v','w','e_lateral','e_heading'};
...
%              'Project05 threw the following error:\n\n' ...
%              'threw the following error:\n\n' ...
%              '==========================\n' ...
%              '%s\n', ...
%              '==========================\n\n' ...
